...
const TrendingBookmark = (props) => {
  ...
  return (
    <TouchableOpacity style={HomeStyle.Setterendingviewbookmark} onPress={() => onPress()}>
      <View>
        <Image source={item.imageset} style={HomeStyle.Imagestylestwobookmark} />
      </View>
...
export default TrendingBookmark;
